        ...
        <main className={styles.divided}>
          <div className={styles.left}>
            <div className={styles.logo}>
              <span className={styles.orange}>AV</span> DESIGNER
            </div>
          </div>
          ...
          >
            <h1>Hello</h1>
            <small>
              We are excited to have you onboard. Enter your details below to
              get started.
            </small>
            <div className={styles.formInputs}>
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  >
                    <path
                      d="M8.25 7.5C8.25 5.42893 9.92893 3.75 12 3.75C14.0711 3.75 15.75 5.42893 15.75 7.5C15.75 9.57107 14.0711 11.25 12 11.25C9.92893 11.25 8.25 9.57107 8.25 7.5ZM12 4.25C10.2051 4.25 8.75 5.70508 8.75 7.5C8.75 9.29492 10.2051 10.75 12 10.75C13.7949 10.75 15.25 9.29492 15.25 7.5C15.25 5.70508 13.7949 4.25 12 4.25Z"
                      fill="#3C4870"
                      stroke="#3C4870"
                    />
                    <path
                      d="M15.4279 14.2865L15.4263 14.287L14.5608 14.5697C14.5608 14.5697 14.5608 14.5697 14.5608 14.5697C12.8968 15.113 11.1032 15.113 9.43922 14.5697C9.4392 14.5697 9.43918 14.5697 9.43916 14.5697L8.57371 14.287L8.5723 14.2866C8.49837 14.2626 8.4203 14.25 8.34087 14.25H8C6.48121 14.25 5.25 15.4813 5.25 17V18.1883C5.25 18.4516 5.44082 18.6758 5.7004 18.7182C9.87251 19.3994 14.1275 19.3994 18.2996 18.7182C18.5592 18.6758 18.75 18.4516 18.75 18.1883V17C18.75 15.4813 17.5187 14.25 16 14.25H15.6591C15.5796 14.25 15.5017 14.2627 15.4279 14.2865ZM9.59435 14.0944L9.59442 14.0944C11.1576 14.6047 12.8424 14.6047 14.4056 14.0944L14.4056 14.0944L15.2709 13.8118C15.271 13.8118 15.271 13.8117 15.271 13.8117C15.2711 13.8117 15.2711 13.8117 15.2711 13.8117C15.3965 13.7708 15.5274 13.75 15.6591 13.75H16C17.795 13.75 19.25 15.205 19.25 17V18.1883C19.25 18.6964 18.8817 19.1297 18.3801 19.2116C14.1547 19.9015 9.8453 19.9015 5.61984 19.2116C5.11826 19.1297 4.75 18.6964 4.75 18.1883V17C4.75 15.205 6.20507 13.75 8 13.75H8.34087C8.4726 13.75 8.60361 13.7709 8.72903 13.8118L9.59435 14.0944Z"
                      fill="#3C4870"
                      stroke="#3C4870"
                    />
                  </svg>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  >
                    <path
                      d="M3.5 6.5L11.3926 12.5355C11.7511 12.8097 12.2489 12.8097 12.6075 12.5355L20.5 6.5M4 18H20C20.5523 18 21 17.5523 21 17V7C21 6.44772 20.5523 6 20 6H4C3.44772 6 3 6.44772 3 7V17C3 17.5523 3.44772 18 4 18Z"
                      stroke="#3C4870"
                      strokeWidth="1.5"
                    />
                  </svg>
